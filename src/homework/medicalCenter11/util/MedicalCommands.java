...
public interface MedicalCommands {
    ...
    static void printCommands() {
        ...
        System.out.println("Please input " + PRINT_PATIENTS_BY_DOCTOR + "  for PRINT_PATIENTS_BY_DOCTOR");
        System.out.println("Please input " + PRINT_ALL_PATIENTS + "  for PRINT_ALL_PATIENTS");
    }
}
